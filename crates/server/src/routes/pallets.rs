    ...
    if *chain_type != ChainType::Relay {
        router
            ...
            .route_registered(
                registry,
                API_VERSION,
                "/rc/pallets/:pallet_id/consts/:constant_item_id",
                "get",
            ...
            .route_registered(
                registry,
                API_VERSION,
                "/rc/pallets/:pallet_id/errors/:error_item_id",
                "get",
            ...
            .route_registered(
                registry,
                API_VERSION,
                "/rc/pallets/:pallet_id/events/:event_item_id",
                "get",
