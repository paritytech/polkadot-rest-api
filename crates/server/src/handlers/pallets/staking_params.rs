//! BABE parameters and staking-related constants for Asset Hub chains.
//!
//! These constants are used by the staking progress endpoints to calculate
//! session timing and election windows.
